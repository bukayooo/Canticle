...
enum Litany {
    ...
    static let items: [LiturgyItem] = [
        ...
        .versicle("That it may please thee to keep and strengthen in the true worshipping of thee, in righteousness and holiness of life, thy Servant Donald Trump, our most gracious President;"),
        .response("We beseech thee to hear us, good Lord."),
